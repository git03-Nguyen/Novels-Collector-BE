...
namespace NovelsCollector.WebAPI.UseCases.V1.Download
{
    [ApiController]
    ...
    public class DownloadController : ControllerBase
    {
        ...
        {
            var filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "wwwroot", dayFolder, formatFolder, fileName);
