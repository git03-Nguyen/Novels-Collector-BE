...
namespace NovelsCollector.Application.UseCases
{
    public abstract class BasePluginsManager<Abstract, Interface>
        where Abstract : IPlugin, new()
        where Interface : IPluginFeature
    {
        ...
        public BasePluginsManager(IPluginRepository<Abstract> pluginRepository, string pluginsFolderName)
        {
            _pluginRepository = pluginRepository;
            _pluginsPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Plugins", pluginsFolderName);
